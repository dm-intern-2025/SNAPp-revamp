...
<form method="GET" class="flex flex-wrap gap-4 mb-4">
  <flux:select name="date" placeholder="Filter by" class="w-36 min-w-[140px] max-w-[160px]" @change="$el.form.submit()">
  ...
  <flux:select name="sort" placeholder="Sort by" class="w-36 min-w-[140px] max-w-[160px]" @change="$el.form.submit()">
